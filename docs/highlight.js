/*!
  ...
  Add support for `basic` language based on the BASIC reference from the Tandy 1000 guide
  https://github.com/highlightjs/highlight.js/blob/main/src/languages/basic.js
  Add additional keywords from Locomotive BASIC 1.1 https://en.wikipedia.org/wiki/Locomotive_BASIC
...
subLanguage:"bash"}}]})})();hljs.registerLanguage("shell",s)})();/*! `basic` grammar compiled for Highlight.js 11.7.0 */
(()=>{var E=(()=>{"use strict";return E=>({name:"BASIC",case_insensitive:!0,
illegal:"^.",keywords:{$pattern:"[a-zA-Z][a-zA-Z0-9_$%!#]*",
keyword:["ABS","ASC","AND","ATN","AUTO|0","BEEP","BLOAD|10","BSAVE|10","CALL","CALLS","CDBL","CHAIN","CHDIR","CHR$|10","CINT","CIRCLE","CLEAR","CLOSE","CLS","COLOR","COM","COMMON","CONT","COS","CSNG","CSRLIN","CVD","CVI","CVS","DATA","DATE$","DEFDBL","DEFINT","DEFSNG","DEFSTR","DEF|0","SEG","USR","DELETE","DIM","DRAW","EDIT","END","ENVIRON","ENVIRON$","EOF","EQV","ERASE","ERDEV","ERDEV$","ERL","ERR","ERROR","EXP","FIELD","FILES","FIX","FOR|0","FRE","GET","GOSUB|10","GOTO","HEX$","IF","THEN","ELSE|0","INKEY$","INP","INPUT","INPUT#","INPUT$","INSTR","IMP","INT","IOCTL","IOCTL$","KEY","ON","OFF","LIST","KILL","LEFT$","LEN","LET","LINE","LLIST","LOAD","LOC","LOCATE","LOF","LOG","LPRINT","USING","LSET","MERGE","MID$","MKDIR","MKD$","MKI$","MKS$","MOD","NAME","NEW","NEXT","NOISE","NOT","OCT$","ON","OR","PEN","PLAY","STRIG","OPEN","OPTION","BASE","OUT","PAINT","PALETTE","PCOPY","PEEK","PMAP","POINT","POKE","POS","PRINT","PRINT]","PSET","PRESET","PUT","RANDOMIZE","READ","REM","RENUM","RESET|0","RESTORE","RESUME","RETURN|0","RIGHT$","RMDIR","RND","RSET","RUN","SAVE","SCREEN","SGN","SHELL","SIN","SOUND","SPACE$","SPC","SQR","STEP","STICK","STOP","STR$","STRING$","SWAP","SYSTEM","TAB","TAN","TIME$","TIMER","TROFF","TRON","TO","USR","VAL","VARPTR","VARPTR$","VIEW","WAIT","WHILE","WEND","WIDTH","WINDOW","WRITE","XOR","AFTER","BREAK","BIN$","BORDER","CAT","CLG","CLOSEIN","CLOSEOUT","COPYCHR$","CREAL","CURSOR","DEC$","DEFREAL","DEG","DERR","DI","DRAWR","EI","ENT","ENV","EVERY","FILL","FN","FRAME","GRAPHICS","HIMEM","INK","INKEY","JOY","LOG10","LOWER$","MASK","MAX","MEMORY","MIN","MODE","MOVE","MOVER","OPENIN","OPENOUT","ORIGIN","PAPER","PI","PLOT","PLOTR","RAD","RELEASE","REMAIN","ROUND","SPEED","SQ","SYMBOL","TAG","TAGOFF","TEST","TESTR","TIME","UNT","UPPER$","VPOS","XPOS","YPOS", "ZONE"]
...
;hljs.registerLanguage("basic",E)})();/*! `objectivec` grammar compiled for Highlight.js 11.7.0 */
