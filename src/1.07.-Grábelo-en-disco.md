...
Finalmente, asegúrese de que ha tenido en cuenta las advertencias que hemos hecho al principio del manual, en la sección titulada [IMPORTANTE](0.02.-Importante): 

* [NOTAS DE INSTALACIÓN](0.02.-Importante#notas-de-instalación) 5, 6 y 7.
* [NOTAS DE OPERACIÓN](0.02.-Importante#notas-de-operación) 1, 2, 3, 4, 5, 6, 7 y 9.

***

&#9664; [Capítulo 1. Parte 6: Empecemos a trabajar](1.06.-Empecemos-a-trabajar)   /  [Índice](0.03.-Contenido)  /   [Capítulo 1. Parte 8: Introducción a los modos de pantalla, colores y gráficos](1.08.-Introducción-a-los-modos-de-pantalla,-colores-y-gráficos) &#9654;
