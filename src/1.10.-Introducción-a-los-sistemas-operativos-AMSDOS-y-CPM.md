...
En los capítulos titulados [Discos y cintas](4.00.-Capítulo-4.-Discos-y-cintas) y [AMSDOS y CP/M](5.00.-Capítulo-5.-AMSDOS-y-CP-M) se puede encontrar más amplia información sobre todas las posibilidades de transferencia de datos entre ordenador, disco y cinta. 

### Copia de programas entre discos y cinta
En la [parte 7](1.07.-Grábelo-en-disco) de este [Curso de introducción](1.00.-Capítulo-1.-Curso-de-introducción) el lector ha aprendido a inicializar discos nuevos sirviéndose del programa **DISCKIT3** (cara 1 del juego de discos maestros de CP/M), y también a copiar programas de un disco a otro. A la vista de la descripción que acabamos de hacer de las órdenes
...
Las explicaremos en el capítulo titulado [AMSDOS y CP/M](5.00.-Capítulo-5.-AMSDOS-y-CP-M). 
...
* [NOTAS DE INSTALACIÓN](0.02.-Importante#notas-de-instalación) 5, 6 y 7.
* [NOTAS DE OPERACIÓN](0.02.-Importante#notas-de-operación) 1 y 2.

***

&#9664; [Capítulo 1. Parte 9: Sonidos](1.09.-Sonidos)   /  [Índice](0.03.-Contenido)  /   [Capítulo 1. Parte 11: Introducción al gestor de bancos de memoria](1.11.-Introducción-al-gestor-de-bancos-de-memoria) &#9654;