...
Para más amplia información sobre las interrupciones, consulte la [parte 2](9.02.-Más-en-concreto-sobre-el-CPC6128) del capítulo titulado [Cuando usted guste](9.00.-Capítulo-9.-Cuando-usted-guste). 
...
Para más amplia información sobre operaciones lógicas, consulte la [parte 2](9.02.-Más-en-concreto-sobre-el-CPC6128) del capítulo titulado [Cuando usted guste](9.02.-Más-en-concreto-sobre-el-CPC6128).
...
*Función.* Convierte la \<expresión entera\>, que tiene que estar en el margen de 0 a 255, en su carácter equivalente. El conjunto de caracteres del AMSTRAD se muestra en la [parte 4](7.04.-Caracteres-ASCII-y-caracteres-gráficos-en-BASIC) del capítulo titulado [Para su referencia](7.00.-Capítulo-7.-Para-su-referencia).
...
Palabras clave asociadas: [**CREAL**](#creal), [**FIX**](#fix), [**INT**](#int), [**ROUND**](#round), [**UNT**](#unt).
...
En la [parte 2](9.02.-Más-en-concreto-sobre-el-CPC6128) del capítulo titulado [Cuando usted guste](9.00.-Capítulo-9.-Cuando-usted-guste) daremos más amplia información sobre los datos de este tipo. 
...
Función. Toma como valor el último código de error detectado por el sistema de archivo en disco. Se puede utilizar el valor de **DERR** para determinar qué error se ha producido. Véase en el capítulo [Para su referencia](7.00.-Capítulo-7.-Para-su-referencia) la lista de los [mensajes de error](7.07.-Mensajes-de-error-de-BASIC). 

Palabras clave asociadas: [**ERL**](#erl), [**ERR**](#err), [**ERROR**](#error), [**ON ERROR GOTO**](#on-error-goto), [**RESUME**](#resume).
...
En la [parte 2](9.02.-Más-en-concreto-sobre-el-CPC6128) del capítulo [Cuando usted guste](9.00.-Capítulo-9.-Cuando-usted-guste) daremos más amplia información a este respecto. 
...
En la [parte 2](9.02.-Más-en-concreto-sobre-el-CPC6128) del capítulo titulado [Cuando usted guste](9.00.-Capítulo-9.-Cuando-usted-guste) daremos más amplia información acerca de las interrupciones. 
...
En la [parte 2](9.02.-Más-en-concreto-sobre-el-CPC6128) del capítulo [Cuando usted guste](9.00.-Capítulo-9.-Cuando-usted-guste) daremos más información sobre las envolventes de tono. 
...
En la [parte 2](9.02.-Más-en-concreto-sobre-el-CPC6128) del capítulo [Cuando usted guste](9.00.-Capítulo-9.-Cuando-usted-guste) daremos más información sobre las envolventes de volumen. 
...
*Función*. Da el número del último error detectado. En el capítulo titulado [Para su referencia](7.00.-Capítulo-7.-Para-su-referencia) se da la lista de los [mensajes de error](7.07.-Mensajes-de-error-de-BASIC). El programa ejemplo muestra que el error número 8 es "Line does not exist" ("no existe esa línea"). 
...
*Orden.* Invoca el error de número especificado por \<expresión entera\>. En el capítulo [Para su referencia](7.00.-Capítulo-7.-Para-su-referencia) se da la lista de los [mensajes de error](7.07.-Mensajes-de-error-de-BASIC) 1 a 32. BASIC trata el **ERROR** como si efectivamente lo hubiera detectado: salta a la rutina de gestión de errores (si la hay) y genera los valores correctos de **ERR** y **ERL**.
...
En la [parte 2](9.02.-Más-en-concreto-sobre-el-CPC6128) del capítulo [Cuando usted guste](9.00.-Capítulo-9.-Cuando-usted-guste) daremos más amplia información acerca de las interrupciones. 
...
Palabras clave asociadas. [**GRAPHICS PEN**](#graphics-pen).
...
El ejemplo anterior detecta cuándo se pulsa **V** (tecla número 55) con **[SHIFT]** y sin **[CTRL]**. El [esquema de la numeración de las teclas](7.05.-Esquemas-de-teclado) está grabado en la carcasa del ordenador, a la derecha del teclado, e impreso en el capítulo titulado [Para su referencia](7.00.-Capítulo-7.-Para-su-referencia). 
...
Palabras clave asociadas: [**CLEAR INPUT**](#clear-input), [**INKEY$**](#inkey-1), [**JOY**](#joy).
...
En el capítulo [Para su referencia](7.00.-Capítulo-7.-Para-su-referencia) daremos más información acerca de los [joysticks](7.12.-Joysticks).
...
El parámetro \<código expansible\> incluido en la orden **KEY** puede estar en el margen de 0 a 31, o bien en el margen 128 a 159 para reflejar directamente [códigos de tecla](7.05.-Esquemas-de-teclado). (Véase la ilustración del capítulo [Para su referencia](7.00.-Capítulo-7.-Para-su-referencia).) 
...
Palabras clave asociadas: [**CHAIN**](#chain), [**CHAIN MERGE**](#chain-merge), [**MERGE**](#merge), [**RUN**](#run), [**SAVE**](save). 
...
En la [parte 2](9.02.-Más-en-concreto-sobre-el-CPC6128) del capítulo [Cuando usted guste](9.00.-Capítulo-9.-Cuando-usted-guste) daremos más amplia información sobre las operaciones lógicas.
...
En la [parte 2](9.02.-Más-en-concreto-sobre-el-CPC6128) del capítulo [Cuando usted guste](9.00.-Capítulo-9.-Cuando-usted-guste) daremos más información sobre los sonidos.
...
Para más amplia información sobre operaciones lógicas, consulte la [parte 2](9.02.-Más-en-concreto-sobre-el-CPC6128) del capítulo titulado [Cuando usted guste](9.00.-Capítulo-9.-Cuando-usted-guste).
...
Palabras clave asociadas: [**GRAPHICS PEN**](#graphics-pen), [**PLOTR**](#plotr). 
...
Palabras clave asociadas: [**VPOS**](#vpos), [**WINDOW**](#window).
...
| :------: | ------------------------------------------------------------ |
| \#       | Cada # especifica una posición (para un dígito).<br />Ejemplo: ###### |
| \.       | Especifica la posición del punto decimal.<br />Ejemplo: ######.## |
| \,        | (Especifica una posición.) Sólo puede aparecer antes del punto decimal. Especifica que los dígitos que queden a la izquierda del punto decimal deben separarse mediante comas en grupos de tres.<br />Ejemplo: #####,.## |

Para antes y después del número:

| Caracteres                      | Descripción                                                  |
| :-----------------------------: | ------------------------------------------------------------ |
| PtPt                           | PtPt (Especifica dos posiciones.) Especifica que se debe escribir un signo Pt inmediatamente antes del primer dígito o del punto decimal, después del signo + o – (si lo hay). Obsérvese que el signo Pt ocupará una de las posiciones para dígitos.<br />Ejemplo: PtPt######,.## |
| \*\* | (Especifica dos posiciones.) Especifica que los espacios libres a la izquierda deben ser rellenados con asteriscos. <br />Ejemplo: \*\*\#\#\#\#\#\#,.\#\# |
| \*\*Pt                           | (Especifica tres posiciones.) Actúa como las opciones ** y PtPt combinadas, es decir, con asteriscos por la izquierda y el signo Pt.<br />Ejemplo: \*\*$### ###,.## |
| $$ | (Especifica dos posiciones.) Especifica que se debe escribir un signo $ inmediatamente antes del primer dígito o del punto decimal, después del signo + o - (si lo hay). Obsérvese que el signo $ ocupará una de las posiciones para dígitos. <br />Ejemplo: $$######,.## |
| \*\*$ | (Especifica tres posiciones.) Actúa como las opciones \*\* y $$ combinadas, es decir, con asteriscos por la izquierda y el signo $.<br />Ejemplo: \*\*$######,.## |
| +                               | Especifica que se debe escribir el signo + o el - (según corresponda). Si se incluye el signo + al principio de la plantilla, el signo se escribirá inmediatamente antes del número (y del signo Pt o $, si se lo ha especificado). Si se incluye el signo + al final de la plantilla, el signo se escribe a la derecha del número (y del exponente, si lo hay).<br />Ejemplo: +####.#### |
| -                               | Este signo sólo se puede poner al final de la plantilla. Especifica que, si el número es negativo, se debe escribir el signo - a su derecha (y a la derecha del exponente, si lo hay). Si el número es positivo, a su derecha se escribe un espacio. Si no se especifica esto, se escribe automáticamente un signo - a la izquierda de todos los números negativos.<br />Ejemplo: ####.####- |
| &#8593;&#8593;&#8593;&#8593; | Especifica que el número se debe escribir en forma exponencial. Los signos &#8593;&#8593;&#8593;&#8593; se deben poner a la derecha de las posiciones para dígitos, pero a la izquierda de los signos + y - (si los hay).<br />Ejemplo: ##.####&#8593;&#8593;&#8593;&#8593;+ |
...
| Caracteres    | Descripción |
| :-----------: | ----------- |
| \!            | Especifica que solamente se debe escribir el primer carácter de la cadena.<br />Ejemplo: ! |
| \\\<espacios\>\\ | Especifica que solamente se deben escribir los x primeros caracteres de la cadena, siendo x la longitud de la plantilla (incluidas las barras inclinadas hacia la izquierda).<br />Ejemplo: \\       \\ |
| \& | Especifica que se debe escribir la cadena completa sin modificarla.<br />Ejemplo \& |
...
En la [parte 2](9.02.-Más-en-concreto-sobre-el-CPC6128) del capítulo [Cuando usted guste](9.00.-Capítulo-9.-Cuando-usted-guste) daremos más información acerca de los formatos de impresión. 

Palabras clave relacionadas: [**SPC**](#spc), [**TAB**](#tab), [**USING**](#using), [**ZONE**](#zone). 
...
Palabras clave asociadas: [**ATN**](#atn), [**COS**](#cos), [**DEG**](#deg), [**SIN**](#sin), [**TAN**](#tan). 
...
Palabras clave asociadas: [**RND**](#rnd). 
...
En la [parte 2](9.02.-Más-en-concreto-sobre-el-CPC6128) del capítulo titulado [Cuando usted guste](9.00.-Capítulo-9.-Cuando-usted-guste) daremos más amplia información a este respecto.

Palabras clave asociadas: [**DATA**](#data), [**RESTORE**](#restore). 
...
En la [parte 2](9.02.-Más-en-concreto-sobre-el-CPC6128) del capítulo [Cuando usted guste](9.00.-Capítulo-9.-Cuando-usted-guste) daremos más amplia información acerca de los sonidos.

Palabras clave asociadas: [**SOUND**](#sound). 
...
En la [parte 2](9.02.-Más-en-concreto-sobre-el-CPC6128) del capítulo [Cuando usted guste](9.00.-Capítulo-9.-Cuando-usted-guste) daremos más información acerca de las interrupciones.
...
Palabras clave asociadas: [**DELETE**](#DELETE), [**LIST**](list). 
...
En la [parte 2](9.02.-Más-en-concreto-sobre-el-CPC6128) del capítulo [Cuando usted guste](9.00.-Capítulo-9.-Cuando-usted-guste) daremos más información a este respecto. 

Palabras clave asociadas: [**DATA**](#data), [**READ**](read).
...
Palabras clave asociadas: [**DERR**](#derr), [**ERL**](#erl), [**ERR**](#err), [**ERROR**](#error), [**ON ERROR GOTO**](#on-error-goto), [**RESUME NEXT**](#resume-next). 
...
Palabras clave asociadas: [**DERR**](#derr), [**ERL**](#erl), [**ERR**](#err), [**ERROR**](#error), [**ON ERROR GOTO**](#on-error-goto), [**RESUME**](#resume). 
...
Palabras clave asociadas: [**GOSUB**](#gosub). 
...
Palabras clave asociadas: [**LEFT$**](#left), [**MID$**](#mid). 
...
Palabras clave asociadas: [**RANDOMIZE**](#randomize).
...
Palabras clave asociadas: [**ABS**](#abs), [**CINT**](#cint), [**FIX**](#fix), [**INT**](#int). 
...
Palabras clave asociadas: [**LOAD**](#load). 
...
Palabras clave asociadas: [**CONT**](#cont), [**END**](#end), [**STOP**](#stop). 
...
Palabras clave asociadas: [**CHAIN**](#chain), [**CHAIN MERGE**](#chain-merge), [**LOAD**](#load), [**MERGE**](#merge), [**RUN**](#run). 
...
Palabras clave asociadas: [**ABS**](#abs). 
...
Palabras clave asociadas: [**ATN**](#atn), [**COS**](#cos), [**RAD**](#rad), [**TAN**](#tan). 
...
Este parámetro define el tono del sonido; es decir, identifica la nota (DO, RE, MI, FA, etc.). Cada nota tiene un número de identificación, que es el \<periodo de tono\>. Véase el capítulo titulado [Para su referencia](7.06.-Sonidos). 
...
En la [parte 2](9.02.-Más-en-concreto-sobre-el-CPC6128) del capítulo [Cuando usted guste](9.00.-Capítulo-9.-Cuando-usted-guste) daremos más amplia información sobre los sonidos. 

Palabras clave asociadas: [**ENT**](#ent), [**ENV**](#env), [**ON SQ GOSUB**](#on-sq-gosub), [**RELEASE**](#release), [**SQ**](#sq). 
...
Palabras clave asociadas: [**SPC**](#spc), [**STRING$**](#string), [**TAB**](#tab). 

### SPC

Véase [**PRINT SPC**](#print-spc).
...
Palabras clave asociadas: [**BORDER**](#border), [**INK**](#ink). 
...
Palabras clave asociadas: [**OPENOUT**](#openout), [**SAVE**](#save). 
...
En la [parte 2](9.02.-Más-en-concreto-sobre-el-CPC6128) del capítulo [Cuando usted guste](9.00.-Capítulo-9.-Cuando-usted-guste) daremos más información acerca de los sonidos. 

Palabras clave asociadas: [**ON SQ GOSUB**](#on-sq-gosub), [**SOUND**](#sound). 
...
Palabras clave asociadas: [**CONT**](#cont), [**END**](#end). 
...
Palabras clave asociadas: [**BIN$**](#bin), [**DEC**](#dec), [**HEX$**](#hex), [**VAL**](#val). 
...
Palabras clave asociadas: [**SPACE$**](#space).

### SWAP

Véase [**WINDOW SWAP**](#window-swap).
...
En la [parte 2](9.02.-Más-en-concreto-sobre-el-CPC6128) del capítulo [Cuando usted guste](9.00.-Capítulo-9.-Cuando-usted-guste) daremos más información sobre la redefinición de caracteres.

Palabras clave asociadas: [**COPYCHR$**](#copychr), [**HIMEM**](#himem), [**MEMORY**](#memory), [**SYMBOL AFTER**](#symbol-after). 
...
Palabras clave asociadas: [**HIMEM**](#himem), [**MEMORY**](#memory), [**SYMBOL**](#symbol).

### TAB

Véase [**PRINT TAB**](#print-tab). 
...
Palabras clave asociadas: [**TAGOFF**](#tagoff). 
...
Palabras clave asociadas: [**TAG**](#tag). 
...
Palabras clave asociadas: [**ATN**](#atn), [**COS**](#cos), [**DEG**](#deg), [**RAD**](#rad), [**SIN**](#sin).
...
Palabras clave asociadas: [**MOVE**](#move), [**MOVER**](#mover), [**TESTR**](#testr), [**XPOS**](#xpos), [**YPOS**](#ypos). 
...
Palabras clave asociadas: [**MOVE**](#move), [**MOVER**](#mover), [**TEST**](#test), [**XPOS**](#xpos), [**YPOS**](#ypos). 
...
Palabras clave asociadas: [**AFTER**](#after), [**EVERY**](#every), [**WEND**](#wend), [**WHILE**](#while). 
...
Palabras clave asociadas: [**CINT**](#cint), [**FIX**](#fix), [**INT**](#int), [**ROUND**](#round). 
...
Palabras clave asociadas: [**LOWER$**](#lower). 

### USING

Véase [**PRINT USING**](#print-using). 
...
Palabras clave asociadas: [**STR$**](#str). 
...
Palabras clave asociadas: [**INP**](#inp), [**OUT**](#out). 
...
Palabras clave asociadas: [**TIME**](#time), [**WHILE**](#while). 
...
Palabras clave asociadas: [**TIME**](#time), [**WEND**](#wend). 
...
Palabras clave asociadas: [**POS**](#pos). 
...
En la [parte 2](9.02.-Más-en-concreto-sobre-el-CPC6128) del capítulo titulado [Cuando usted guste](9.00.-Capítulo-9.-Cuando-usted-guste) daremos más información sobre ventanas de texto. 

Palabras clave asociadas: [**WINDOW SWAP**](#window-swap). 
...
Palabras clave asociadas: [**INPUT**](#input), [**LINE INPUT**](#line-input). 
...
Palabras clave asociadas: [**AND**](#and), [**OR**](#or), [**NOT**](#not). 
...
Palabras clave asociadas: [**MOVE**](#move), [**MOVER**](#mover), [**ORIGIN**](#origin), [**YPOS**](#ypos). 
...
Palabras clave asociadas: [**MOVE**](#move), [**MOVER**](#mover), [**ORIGIN**](#origin), [**XPOS**](#xpos). 
...
Palabras clave asociadas: [**PRINT**](#print), [**WIDTH**](#width). 

***

&#9664; [Capítulo 3. Lista completa de las palabras clave del BASIC de AMSTRAD](3.00.-Capítulo-3.-Lista-completa-de-las-palabras-clave-del-BASIC-de-AMSTRAD)   /  [Índice](0.03.-Contenido)  /   [Capítulo 4. Discos y cintas](4.00.-Capítulo-4.-Discos-y-cintas) &#9654;
