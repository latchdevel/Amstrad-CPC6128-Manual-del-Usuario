...
Pues bien. Usted ya ha leído el [Curso de introducción](1.00.-Capítulo-1.-Curso-de-introducción) y tiene ante sí el ordenador encendido. Ya sabe cómo hacer que el ordenador repita una tarea varias veces con la instrucción **FOR ... NEXT** y cómo hacerle realizar operaciones de forma condicional con la instrucción **IF...** **THEN...** .
...
¿Recuerda todavía los programas del [Curso de Introducción](1.00.-Capítulo-1.-Curso-de-introducción)? En algunos de ellos utilizábamos la instrucción **INPUT** para captar los valores de las variables. Escribamos:
...
&#9664; [Capítulo 2. La génesis de un programa](2.00.-Capítulo-2.-La-génesis-de-un-programa)   /  [Índice](0.03.-Contenido)  /   [Capítulo 3. Lista completa de las palabras clave del BASIC de AMSTRAD](3.00.-Capítulo-3.-Lista-completa-de-las-palabras-clave-del-BASIC-de-AMSTRAD) &#9654;